...
import greedy.ListsIntersection.Pair;
...
public class ListsIntersectionTest {
	...
	public void testIntercalateHelperMethod() {
		int[] l1 = new int[] {};
		int[] l2 = new int[] {};
		int[] out = new ListsIntersection().interc(l1, l2);
	...
	public void noListsToIntercalate() {
		Pair out = new ListsIntersection()._intercalate();
	...
	public void onlyOneListToIntercalate() {
		Pair out = new ListsIntersection()._intercalate(new int[] { 10, 20 });
	...
	public void OnlyTwoListsToIntercalate() {
		...
		Pair out = new ListsIntersection()._intercalate(l1, l2);
	...
	public void threeListsToIntercalate() {
		...
		Pair out = new ListsIntersection()._intercalate(l1, l2, l3);
