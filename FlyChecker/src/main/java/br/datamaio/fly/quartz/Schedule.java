...
public class Schedule {
	...
	@NotNull(message = "O nome do agendamento é obrigat�rio!")
	@Size(min = 4, max = 64, message = "Tamanho do nome deve ser maior que 4 e menor que 64 posi��es!")
	private String name;

	@Column(name = "jobClass")
	@NotNull(message = "A classe do Job é obrigat�ria!")
	private Class<? extends Job> jobClass;

	@Enumerated(EnumType.STRING)
	@Column(name = "frequency")
	@NotNull(message = "O tipo do agendamento é obrigat�rio!")
	private Frequency frequency;	
	
	// PERIODICO
	@Column(name = "cron", nullable = true, length = 64)
	@Cron	
	@NotNull(message = "Para agendamento periodico a express�o Cron é obrigat�ria!", groups = Periodic.class)
	private String cron;

	@Temporal(TemporalType.DATE)
	@Column(name = "from", nullable = true)
	@Future(message = "A data inicial deve estar no futuro!")
	@NotNull(message = "Para agendamento periodico a data inicial é obrigat�ria!", groups = Periodic.class)
	private LocalDateTime from;
	
	@Temporal(TemporalType.DATE)
	@Column(name = "dataFinal", nullable = true)
	@Future(message = "A data final deve estar no futuro!")
	@NotNull(message = "Para agendamento periodico a data final é obrigat�ria!", groups = Periodic.class)
	...
	@NotNull(message = "Para agendamento �nico a data e hora é obrigat�ria!", groups = Single.class)
	...
	/**
	 * Retorna o nome que ser� utilizado no Job
	 *
