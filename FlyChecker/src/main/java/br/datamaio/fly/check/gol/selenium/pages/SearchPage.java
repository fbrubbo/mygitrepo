...
public class SearchPage {
	...
	public SearchPage returning(final LocalDate date) {
		if (trip == TripType.ONE_WAY) {
			throw new IllegalStateException("NÑo pode chamar o m»todo returning(..) se » oneway trip");
		}
	...
	public SelectFlyPage buy() {
		...
		try {
			...
			Thread.sleep(700);						// TODO: por algum motivo, o waituntil acima n„o È suficiente.. verificar porque
			buy.click();
		} catch (Exception e) {
			e.printStackTrace();
		}
