...
public class ContractTest {
    ...
    public void getYearConsumption(){
        ...
        assertThat(years3, hasItem(equalTo(new YearConsumption(2013, new BigDecimal("3.13"), new BigDecimal("63101.71")))));   // 78.135,50571 - 4 meses (é o que fez a diferença)
        ...
        assertThat(years4, hasItem(equalTo(new YearConsumption(2015, new BigDecimal("8.97"), new BigDecimal("2412430.38"))))); // não tinha calculado o 2015
    }
}
